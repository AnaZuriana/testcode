...
namespace MyApplication.Database
{
    public class Conversion
    {
        ...
        public static readonly DateTime DEFAULT_DATETIME; // equals "1/1/0001 12:00:00 AM"
        ...
        public static byte[] DEFAULT_BYTE_ARRAY = new byte[0];
        ...
        public const char DEFAULT_CHAR = Char.MinValue; // equals ' '

        // No constant for default GUID - Guid.Empty is not a compile-time constant.
        #endregion
        ...
        public static bool? DBNullToNullableBoolean(object input)
        {
            if (input is DBNull)
                return null;
        ...
        public static DateTime? DBNullToNullableDateTime(object input)
        {
            if (input is DBNull)
                return null;
        ...
        public static float? DBNullToNullableSingle(object input)
        {
            if (input is DBNull)
                return null;
        ...
        public static double? DBNullToNullableDouble(object input)
        {
            if (input is DBNull)
                return null;
        ...
        public static decimal? DBNullToNullableDecimal(object input)
        {
            if (input is DBNull)
                return null;
        ...
        public static long? DBNullToNullableInt64(object input)
        {
            if (input is DBNull)
                return null;
        ...
        public static int? DBNullToNullableInt32(object input)
        {
            if (input is DBNull)
                return null;
        ...
        public static short? DBNullToNullableInt16(object input)
        {
            if (input is DBNull)
                return null;
        ...
        public static byte? DBNullToNullableByte(object input)
        {
            if (input is DBNull)
                return null;
        ...
        public static ulong? DBNullToNullableUInt64(object input)
        {
            if (input is DBNull)
                return null;
        ...
        public static uint? DBNullToNullableUInt32(object input)
        {
            if (input is DBNull)
                return null;
        ...
        public static ushort? DBNullToNullableUInt16(object input)
        {
            if (input is DBNull)
                return null;
        ...
        public static sbyte? DBNullToNullableSByte(object input)
        {
            if (input is DBNull)
                return null;
        ...
        public static char? DBNullToNullableChar(object input)
        {
            if (input is DBNull)
                return null;
        ...
        /// <summary>
        /// Returns either the original database value as a Guid
        /// or Guid.Empty if that value is DBNull or null.
        /// </summary>
        /// <param name="input">Database value to inspect</param>
        /// <returns>Guid.Empty if input is DBNull or null, input converted to a Guid otherwise</returns>
        public static Guid DBNullToGuid(object input)
        {
            return DBNullToGuid(input, Guid.Empty);
        }

        /// <summary>
        /// Returns either the original database value as a Guid
        /// or the defaultValue parameter if that value is DBNull or null.
        /// </summary>
        /// <param name="input">Database value to inspect</param>
        /// <param name="defaultValue">Value to use if input is DBNull or null</param>
        /// <returns>defaultValue if input is DBNull or null, input converted to a Guid otherwise</returns>
        public static Guid DBNullToGuid(object input, Guid defaultValue)
        {
            // Nothing to convert - use the default...
            if (input is DBNull)
                return defaultValue;
            if (input == null)
                return defaultValue;
            // At this point, for most anything else, ToString() will get the object into a format we can
            // get a Guid out of.  But it won't work for byte arrays, and Guid has a constructor for them.
            // So, if we can cast to a byte array, let's do that - otherwise, use the string-based constructor.
            var bytes = input as byte[];
            if (bytes != null) return new Guid(bytes);

            // Guid is a value type, and its constructor cannot take a generic object.  Converting
            // input object to String, which Guid constructor *can* handle.
            return new Guid(Convert.ToString(input));
        }


        /// <summary>
        /// Generic conversion from DBNull to type T
        /// </summary>
        /// <typeparam name="T">Type of the return value.</typeparam>
        /// <param name="input">Input object.</param>
        /// <returns>
        /// Either <code>input</code> converted to T (if not null), or the default value for T,
        /// if <code>input</code> is null.
        /// </returns>
        public static T DBNullToT<T>(object input) where T : IConvertible
        {
            return DBNullToT<T>(input, default(T));
        }
        ...
        /// <typeparam name="T">Type of the return value.</typeparam>
        /// <param name="input">Input object.</param>
        /// <param name="defaultValue">Default value to use if input is null.</param>
        /// <returns>
        /// Either <code>input</code> converted to T (if not null), or the <code>defaultValue</code>,
        /// if <code>input</code> is null.
        /// </returns>
